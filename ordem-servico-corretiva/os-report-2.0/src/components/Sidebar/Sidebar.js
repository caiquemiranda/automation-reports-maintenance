    ...
    <div className={`sidebar ${expanded ? 'expanded' : 'collapsed'}`}>
      ...
      <div className="sidebar-content">
        <div className="section-content">
          ...
          <p className={`sidebar-label${expanded ? '' : ' hidden'}`}>Ações</p>
